...
class GetHelp extends Component {
  ...
  getLocation = () => {
    useRef().current && useRef().current.getLocation();
  };
  ...
  render() {
    // const location =
    //   <div>
    //     <Demo onError={(error) => console.log(error)} ref={useRef()} />
    //     <button
    ...
    return (
      ...
      <div class="gethelp-main-container">
        ...
        <div class="gethelp-options">
          ...
          <div class="gethelp-option-button">
            <button class="option-submit-button" onClick={(e) => this.setState({ title: 'Medication Pick Up' })}>
          ...
          <Link to="/submit"><button
            ...
            onClick={(e) => {
              this.props.addPost(
                ...
                this.props.name(), this.state.title, this.state.content, this.state.user_id)
            }}
