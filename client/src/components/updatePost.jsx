   ...
   render() {
    ...
    return (
      <div class="updatepost">
        <h1>Hello {this.props.post.name}</h1>
        <form
          class="edit-form"
          onSubmit={(e) => {
          e.preventDefault();
...
//         await this.props.setPostForm(this.props.personalPost.posts.name, this.props.personalPost.posts.user_id);
//       }
...
//             </button>
//             <p class="option-text">Grocery shopping &  </p>
//             <p class="option-text">delivery</p>
//           </div>
//           <div class="gethelp-option-button">
//             <button
//               class="option-submit-button-medical"
//               value={this.state.title}
//               name="title" 
//               onClick={(e) => this.setState({ title: 'Medication' })}
...
//               name="title" 
//               onClick={this.props.handleChange} 
//               onClick={(e) => this.setState({ title: 'Post Office' })} >
//               <svg class="vol" width="105" height="84" viewBox="0 0 105 84" xmlns="http://www.w3.org/2000/svg">
//                 <path d="M93.7498 0H20.8332C15.0884 0 10.4165 4.67187 10.4165 10.4167V36.4583H20.8332V20.8333L54.1665 45.8333C55.0684 46.5087 56.1648 46.8737 57.2915 46.8737C58.4182 46.8737 59.5146 46.5087 60.4165 45.8333L93.7498 20.8333V67.7083H52.0832V78.125H93.7498C99.4946 78.125 104.166 73.4531 104.166 67.7083V10.4167C104.166 4.67187 99.4946 0 93.7498 0ZM57.2915 35.1562L24.3019 10.4167H90.2811L57.2915 35.1562Z"  />
//                 <path d="M0 41.6666H36.4583V52.0833H0V41.6666ZM10.4167 57.2916H41.6667V67.7083H10.4167V57.2916ZM26.0417 72.9166H46.875V83.3333H26.0417V72.9166Z" />
//               </svg>
//             </button>
//             <p class="option-text">Post office pickup &  </p>
//             <p class="option-text">dropoff</p>
//           </div>
//           <div class="gethelp-option-button">
//             <button
//               class="option-submit-button"
...
//               name="title" 
//               onClick={this.props.handleChange} 
//               onClick={(e) => this.setState({ title: 'Someone To Talk To!' })}>
//               <svg class="vol" width="108" height="94" viewBox="0 0 108 94" xmlns="http://www.w3.org/2000/svg">
//                 <path fill-rule="evenodd" clip-rule="evenodd" d="M40.1834 0C18.0046 0 0 13.4645 0 30.0732C0 45.2249 15.0095 57.734 34.5048 59.8007L26.231 76.301L55.0234 58.005C69.8567 53.5733 81.2544 42.7516 81.2544 30.0732C81.2544 13.4713 62.3689 0 40.1834 0Z"  />
//                 <path fill-rule="evenodd" clip-rule="evenodd" d="M108 60.2413C108 52.6247 100.804 44.7371 92.4891 40.8069C90.158 54.0206 79.4515 66.1841 62.5582 70.941L54.5148 75.2914C57.5912 77.5953 61.3588 79.4317 65.5872 80.6311L90.2394 93.9872L81.4099 81.9525C96.4329 80.4278 108 71.307 108 60.2413Z" />
//               </svg>
//             </button>
//             <p class="option-text">Conversation & social</p>
//             <p class="option-text">support</p>
//           </div>
//         </div >
//         <form
//           class="gethelp-form"
...
//               <input class="gethelp-type-input" type="checkbox" name="email" onClick={(e) => this.setState({ contact: this.state.contact.concat(' Email' )})} />
//                 <p>Email</p>
//               </div>
//               <div class="gethelp-type">
//               <input class="gethelp-type-input" type="checkbox" name="phone" onClick={(e) => this.setState({ contact: this.state.contact.concat(' Phone' )})} />
//                 <p>Phone</p>
//                 </div>
//             </form>
//           </div> */}
